...
import Contact from "../components/contactDetail.jsx";
          ...
          <div className="form-group">
            ...
            <details>
              ...
              <Input
                ...
                onChange={(e) =>
                  setHobbies({ ...hobbie, three: e.target.value })
                }
              />
            </details>
        ...
        <div className="actual-resume" ref={captureRef}>
          ...
          <div className="personal-detail">
            ...
            <div className="contact-detail">
              ...
              <Contact
                email={personalDetail.email || "satyamrk18@gmail.com"}
                phone={personalDetail.Phone || "7588035979"}
                address={
          ...
          <div className="main-detail">
            ...
            <div className="experience">
              ...
              <div className="work-experience-dates">
                <p className="work-experience comapnyName">
                  {experience.company || `svit`}
                </p>
              ...
              sequi dolores quos minima natus aspernatur.Temporibus iste itaque, ab culpa velit iure
              sapiente ipsum officia quam nobis accusantium enim tenetur tempora
              sequi dolores quos minima natus aspernatu`}
              </p>
            </div>
            {/* certification */}
